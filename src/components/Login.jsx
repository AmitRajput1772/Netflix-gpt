  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="flex justify-center items-center min-h-screen w-full">
        <form className="bg-black/60 p-8 rounded-lg text-white w-[350px] min-h-[450px] flex flex-col  justify-items-center m-auto">
          ...
          {/* Sign In Button */}
          <button className="p-3 bg-red-600 hover:bg-red-700 rounded-md font-semibold w-full">
            {isSignInForm ? "Sign In" : "Sign Up"}
          </button>
          ...
          {/* Use Sign-in Code */}
          <button className="p-3 bg-gray-500 hover:bg-gray-600 rounded-md font-semibold w-full">
            Use a Sign-in Code
          </button>
